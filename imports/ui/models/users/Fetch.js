export default {
  ...
  reducers: {
    ...
    setLoadSuccess(state, payload) {
      return { ...state, loadSuccess: payload };
    },

    setLoadUsers(state, payload) {
      return { ...state, loadUsers: payload };
    },

    setLoadedCount(state, payload) {
      return { ...state, loadedCount: payload };
    },
    incLoadedCount(state, payload) {
      return { ...state, loadedCount: state.loadedCount + payload };
    }
  },
  effects: {}
};
