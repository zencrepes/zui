    ...
    return (
      <React.Fragment>
        ...
        <p className={classes.paragraph}>
          ...
          Some teams use T-Shirt sizes (S, M, XL, ...), others points (1, 2, 3,
          5...). <br />
          ZenCrepes uses points for its estimates through labels. Simply attach
          a label using the format SP:X (with X being points) to your issues.
        </p>
        <p className={classes.subtitle}>Understand your metrics!</p>
        <p className={classes.paragraph}>
          ZenCrepes provide various metrics and data points, those are{" "}
          <b>NOT</b> indisputable truth. Understand what you&apos;re asking the
          system to provide, what are the implications of this request.
        ...
        <p className={classes.paragraph}>
          ...
          implementation. Some of its data might not work in your context or not
          reflect team&apos;s workflow.
        </p>
