...
class Wizard extends Component {
  ...
  render() {
    const { classes, activeStep, steps, userAuth } = this.props;
    return (
      <General>
          ...
          <CardActions className={classes.wizardCardActions}>
            <div className={classes.actionButtons}>
              ...
              <Button
                ...
                className={classes.button}
                disabled={
                  activeStep === steps.length - 2 && isEmpty(userAuth)
                    ? true
                    : false
                } // Disable the finish button if no issues
              >
...
export default connect(
  mapState,
  mapDispatch
)(withRouter(withStyles(styles)(Wizard)));
