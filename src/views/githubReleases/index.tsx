...
const mapDispatch = (dispatch: any) => ({
  updateQueryIfDifferent: dispatch.githubReleases.updateQueryIfDifferent,
});
...
export default withRouter(connect(mapState, mapDispatch)(GithubReleases));
