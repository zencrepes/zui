...
const mapState = (state: iRootState) => ({
  query: state.githubReleases.query,
  tablePaginationRowsPerPage: state.githubReleases.tablePaginationRowsPerPage,
  tablePaginationCurrentPage: state.githubReleases.tablePaginationCurrentPage,
  tablePaginationOffset: state.githubReleases.tablePaginationOffset,
  tablePaginationLimit: state.githubReleases.tablePaginationLimit,
});

const mapDispatch = (dispatch: any) => ({
  setTablePaginationRowsPerPage: dispatch.githubReleases.setTablePaginationRowsPerPage,
  setTablePaginationCurrentPage: dispatch.githubReleases.setTablePaginationCurrentPage,
  setTablePaginationOffset: dispatch.githubReleases.setTablePaginationOffset,
  setTablePaginationLimit: dispatch.githubReleases.setTablePaginationLimit,
});
