...
const mapDispatch = (dispatch: any) => ({
  updateQueryIfDifferent: dispatch.githubMilestones.updateQueryIfDifferent,
});
...
const GithubMilestones: React.FC<connectedProps> = (props: connectedProps) => {
  const classes = useStyles();
  const { updateQueryIfDifferent, location, history } = props;

  const pushNewQuery = (modifiedQuery: any) => {
    history.push({
      pathname: '/githubMilestones',
...
export default withRouter(connect(mapState, mapDispatch)(GithubMilestones));
