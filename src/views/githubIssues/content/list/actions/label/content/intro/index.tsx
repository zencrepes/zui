  ...
  return (
    <React.Fragment>
      <Typography variant="body1" gutterBottom>
        This modal will guide you through various steps towards add a label to multiple issues or remove a label from
        multiple issues.
      </Typography>
      ...
      <List>
        <ListItem>
          ...
          <ListItemText primary={'Write access to both the corresponding issues repositories'} />
        </ListItem>
        <ListItem>
          <ListItemIcon>
            <LabelIcon />
          ...
          <ListItemText
            primary={
              'Enough API resource chips (GitHub allocates 5000 per hour), each issue modification uses one chip'
            }
          />
        </ListItem>
        <ListItem>
