      ...
      datasets: [
        {
          ...
          borderWidth: 2,
          data: prepBuckets
            .filter((b: any) => data.bambooRuns[b.key] !== undefined)
            .map((b: any) => data.bambooRuns[b.key].items.totalCount),
        },
      ],
      states: buckets.filter((b: any) => data.bambooRuns[b.key] !== undefined).map((b: any) => b.name),
    };
    return (
