...
const mapDispatch = (dispatch: any) => ({
  updateQueryIfDifferent: dispatch.bambooRuns.updateQueryIfDifferent,
});
...
const BambooRuns: React.FC<connectedProps> = (props: connectedProps) => {
...
export default withRouter(connect(mapState, mapDispatch)(BambooRuns));
