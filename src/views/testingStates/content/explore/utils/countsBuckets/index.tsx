      ...
      datasets: [
        {
          ...
          borderWidth: 2,
          data: prepBuckets
            .filter((b: any) => data.testingStates[b.key] !== undefined)
            .map((b: any) => data.testingStates[b.key].items.totalCount),
        },
      ],
      states: buckets.filter((b: any) => data.testingStates[b.key] !== undefined).map((b: any) => b.name),
    };
    return (
