...
const mapState = (state: iRootState) => ({
  query: state.testingStates.query,
  tablePaginationRowsPerPage: state.testingStates.tablePaginationRowsPerPage,
  tablePaginationCurrentPage: state.testingStates.tablePaginationCurrentPage,
  tablePaginationOffset: state.testingStates.tablePaginationOffset,
  tablePaginationLimit: state.testingStates.tablePaginationLimit,
});

const mapDispatch = (dispatch: any) => ({
  setTablePaginationRowsPerPage: dispatch.testingStates.setTablePaginationRowsPerPage,
  setTablePaginationCurrentPage: dispatch.testingStates.setTablePaginationCurrentPage,
  setTablePaginationOffset: dispatch.testingStates.setTablePaginationOffset,
  setTablePaginationLimit: dispatch.testingStates.setTablePaginationLimit,
});
