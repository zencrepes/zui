...
const mapState = (state: iRootState) => ({
  ...
  verifFlag: state.githubRepositories.verifFlag,
...
const mapDispatch = (dispatch: any) => ({
  ...
  setVerifiedRepos: dispatch.githubRepositories.setVerifiedRepos,
  //   setStageFlag: dispatch.githubRepositories.setStageFlag,
  //   setLabels: dispatch.githubRepositories.setLabels,
  //   setVerifiedLabels: dispatch.githubRepositories.setVerifiedLabels,
  insVerifiedRepos: dispatch.githubRepositories.insVerifiedRepos,
