...
const mapState = (state: iRootState) => ({
  openEditModal: state.githubRepositories.openEditModal,
  editAction: state.githubRepositories.editAction,
});

const mapDispatch = (dispatch: any) => ({
  setOpenEditModal: dispatch.githubRepositories.setOpenEditModal,
  setUpdateTeamSlug: dispatch.githubRepositories.setUpdateTeamSlug,
  setUpdateTeamPermission: dispatch.githubRepositories.setUpdateTeamPermission,
