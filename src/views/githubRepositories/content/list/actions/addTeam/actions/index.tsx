...
const mapState = (state: iRootState) => ({
  updateAddTeamSteps: state.githubRepositories.updateAddTeamSteps,
  updateCurrentStep: state.githubRepositories.updateCurrentStep,
  editDisableNext: state.githubRepositories.editDisableNext,
});

const mapDispatch = (dispatch: any) => ({
  setUpdateCurrentStep: dispatch.githubRepositories.setUpdateCurrentStep,
