      ...
      datasets: [
        {
          ...
          borderWidth: 2,
          data: prepBuckets
            .filter((b: any) => data.githubProjects[b.key] !== undefined)
            .map((b: any) => data.githubProjects[b.key].items.totalCount),
        },
      ],
      projects: buckets.filter((b: any) => data.githubProjects[b.key] !== undefined).map((b: any) => b.name),
    };
    return (
