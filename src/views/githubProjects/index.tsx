...
const mapDispatch = (dispatch: any) => ({
  updateQueryIfDifferent: dispatch.githubProjects.updateQueryIfDifferent,
});
...
export default withRouter(connect(mapState, mapDispatch)(GithubProjects));
