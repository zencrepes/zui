      ...
      datasets: [
        {
          ...
          borderWidth: 2,
          data: buckets
            .filter((b: any) => data.githubWatchers[b.key] !== undefined)
            .map((b: any) => data.githubWatchers[b.key].items.totalCount),
        },
      ],
      labels: buckets.filter((b: any) => data.githubWatchers[b.key] !== undefined).map((b: any) => b.name),
    };
    return (
