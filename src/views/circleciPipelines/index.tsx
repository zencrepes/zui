...
const mapDispatch = (dispatch: any) => ({
  updateQueryIfDifferent: dispatch.circleciPipelines.updateQueryIfDifferent,
});
...
const GithubWatchers: React.FC<connectedProps> = (props: connectedProps) => {
  ...
  if (data === undefined) {
    ...
    const facets: Facet[] = data.circleciPipelines.config.aggregations.nodes;
    const tableConfig: TableConfig = data.circleciPipelines.config.table;
    return (
      <Layout>
...
export default withRouter(connect(mapState, mapDispatch)(GithubWatchers));
