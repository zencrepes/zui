...
import JiraIssueWide from './circleciPipelineWide';
...
const mapState = (state: iRootState) => ({
  ...
  tablePaginationRowsPerPage: state.circleciPipelines.tablePaginationRowsPerPage,
  tablePaginationCurrentPage: state.circleciPipelines.tablePaginationCurrentPage,
  tablePaginationOffset: state.circleciPipelines.tablePaginationOffset,
  tablePaginationLimit: state.circleciPipelines.tablePaginationLimit,
});

const mapDispatch = (dispatch: any) => ({
  setTablePaginationRowsPerPage: dispatch.circleciPipelines.setTablePaginationRowsPerPage,
  setTablePaginationCurrentPage: dispatch.circleciPipelines.setTablePaginationCurrentPage,
  setTablePaginationOffset: dispatch.circleciPipelines.setTablePaginationOffset,
  setTablePaginationLimit: dispatch.circleciPipelines.setTablePaginationLimit,
});
