...
const mapState = (state: iRootState) => ({
  ...
  tablePaginationRowsPerPage: state.circleciEnvvars.tablePaginationRowsPerPage,
  tablePaginationCurrentPage: state.circleciEnvvars.tablePaginationCurrentPage,
  tablePaginationOffset: state.circleciEnvvars.tablePaginationOffset,
  tablePaginationLimit: state.circleciEnvvars.tablePaginationLimit,
});

const mapDispatch = (dispatch: any) => ({
  setTablePaginationRowsPerPage: dispatch.circleciEnvvars.setTablePaginationRowsPerPage,
  setTablePaginationCurrentPage: dispatch.circleciEnvvars.setTablePaginationCurrentPage,
  setTablePaginationOffset: dispatch.circleciEnvvars.setTablePaginationOffset,
  setTablePaginationLimit: dispatch.circleciEnvvars.setTablePaginationLimit,
});
