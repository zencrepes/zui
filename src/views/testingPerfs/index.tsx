...
const mapDispatch = (dispatch: any) => ({
  updateQueryIfDifferent: dispatch.testingPerfs.updateQueryIfDifferent,
});
...
const TestingPerfs: React.FC<connectedProps> = (props: connectedProps) => {
...
export default withRouter(connect(mapState, mapDispatch)(TestingPerfs));
