...
const ProfilesTable: React.FC<Props> = (props: Props) => {
        ...
        <Table className={classes.table} size="small" aria-label="a dense table">
          <TableHead>
            <TableRow>
              ...
              <TableCell align="right">Res. Time (Median)</TableCell>
          ...
          <TableBody>
            {run.runs.edges.map((run: any) => (
              <TableRow key={run.node.id}>
                ...
                <TableCell align="right">
                  {Math.round(
                    run.node.statistics.find((s: any) => s.transaction === selectedTransaction).medianResTime,
                  ) + 'ms'}
                </TableCell>
                <TableCell align="right">
