...
const mapState = (state: iRootState) => ({
  perfData: state.testingPerfs.compareComparisonData,
});
...
const Reference: React.FC<connectedProps> = (props: connectedProps) => {
  ...
  return (
    <CustomCard headerTitle="Comparing with" headerFactTitle="Included runs" headerFactValue={perfData.runs.length}>
