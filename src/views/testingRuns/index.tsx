...
const mapDispatch = (dispatch: any) => ({
  updateQueryIfDifferent: dispatch.testingRuns.updateQueryIfDifferent,
});
...
const TestingRuns: React.FC<connectedProps> = (props: connectedProps) => {
...
export default withRouter(connect(mapState, mapDispatch)(TestingRuns));
