...
const mapState = (state: iRootState) => ({
  ...
  tablePaginationRowsPerPage: state.testingRuns.tablePaginationRowsPerPage,
  tablePaginationCurrentPage: state.testingRuns.tablePaginationCurrentPage,
  tablePaginationOffset: state.testingRuns.tablePaginationOffset,
  tablePaginationLimit: state.testingRuns.tablePaginationLimit,
});

const mapDispatch = (dispatch: any) => ({
  setTablePaginationRowsPerPage: dispatch.testingRuns.setTablePaginationRowsPerPage,
  setTablePaginationCurrentPage: dispatch.testingRuns.setTablePaginationCurrentPage,
  setTablePaginationOffset: dispatch.testingRuns.setTablePaginationOffset,
  setTablePaginationLimit: dispatch.testingRuns.setTablePaginationLimit,
});
