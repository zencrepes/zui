...
const mapDispatch = (dispatch: any) => ({
  updateQueryIfDifferent: dispatch.jiraIssues.updateQueryIfDifferent,
});
...
const GithubWatchers: React.FC<connectedProps> = (props: connectedProps) => {
  ...
  if (data === undefined) {
    ...
    const facets: Facet[] = data.jiraIssues.config.aggregations.nodes;
    const tableConfig: TableConfig = data.jiraIssues.config.table;
    return (
      <Layout>
