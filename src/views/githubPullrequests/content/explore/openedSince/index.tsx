      ...
      datasets: [
        {
          ...
          borderWidth: 2,
          data: buckets
            .filter((b: any) => data.githubPullrequests[b.key] !== undefined)
            .map((b: any) => data.githubPullrequests[b.key].items.totalCount),
        },
      ],
      labels: buckets.filter((b: any) => data.githubPullrequests[b.key] !== undefined).map((b: any) => b.name),
    };
    return (
