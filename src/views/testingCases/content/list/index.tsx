...
const mapState = (state: iRootState) => ({
  ...
  tablePaginationRowsPerPage: state.testingCases.tablePaginationRowsPerPage,
  tablePaginationCurrentPage: state.testingCases.tablePaginationCurrentPage,
  tablePaginationOffset: state.testingCases.tablePaginationOffset,
  tablePaginationLimit: state.testingCases.tablePaginationLimit,
});

const mapDispatch = (dispatch: any) => ({
  setTablePaginationRowsPerPage: dispatch.testingCases.setTablePaginationRowsPerPage,
  setTablePaginationCurrentPage: dispatch.testingCases.setTablePaginationCurrentPage,
  setTablePaginationOffset: dispatch.testingCases.setTablePaginationOffset,
  setTablePaginationLimit: dispatch.testingCases.setTablePaginationLimit,
});
