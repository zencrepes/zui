...
const mapDispatch = (dispatch: any) => ({
  updateQueryIfDifferent: dispatch.testingCases.updateQueryIfDifferent,
});
...
export default withRouter(connect(mapState, mapDispatch)(TestingCases));
