      ...
      datasets: [
        {
          ...
          borderWidth: 2,
          data: prepBuckets
            .filter((b: any) => data.githubLabels[b.key] !== undefined)
            .map((b: any) => data.githubLabels[b.key].items.totalCount),
        },
      ],
      labels: buckets.filter((b: any) => data.githubLabels[b.key] !== undefined).map((b: any) => b.name),
    };
    return (
