...
const mapState = (state: iRootState) => ({
  updateCreateSteps: state.githubLabels.updateCreateSteps,
...
const Actions: React.FC<connectedProps> = (props: connectedProps) => {
  const { updateCreateSteps, updateCurrentStep, setUpdateCurrentStep, setLoading } = props;
  ...
  return (
    <DialogActions>
      ...
      {updateCurrentStep === updateCreateSteps.length - 1 ? (
        <SubmitButton />
      ) : (
