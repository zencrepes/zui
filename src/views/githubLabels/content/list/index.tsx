...
const mapState = (state: iRootState) => ({
  ...
  tablePaginationOffset: state.githubLabels.tablePaginationOffset,
  tablePaginationLimit: state.githubLabels.tablePaginationLimit,
});

const mapDispatch = (dispatch: any) => ({
  setTablePaginationRowsPerPage: dispatch.githubLabels.setTablePaginationRowsPerPage,
  setTablePaginationCurrentPage: dispatch.githubLabels.setTablePaginationCurrentPage,
  setTablePaginationOffset: dispatch.githubLabels.setTablePaginationOffset,
  setTablePaginationLimit: dispatch.githubLabels.setTablePaginationLimit,
});
