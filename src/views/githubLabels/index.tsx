...
const mapDispatch = (dispatch: any) => ({
  updateQueryIfDifferent: dispatch.githubLabels.updateQueryIfDifferent,
});
...
const GithubLabels: React.FC<connectedProps> = (props: connectedProps) => {
...
export default withRouter(connect(mapState, mapDispatch)(GithubLabels));
