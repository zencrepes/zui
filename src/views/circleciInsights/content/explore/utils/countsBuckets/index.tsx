      ...
      datasets: [
        {
          ...
          borderWidth: 2,
          data: prepBuckets
            .filter((b: any) => data.circleciInsights[b.key] !== undefined)
            .map((b: any) => data.circleciInsights[b.key].items.totalCount),
        },
      ],
      labels: buckets.filter((b: any) => data.circleciInsights[b.key] !== undefined).map((b: any) => b.name),
    };
    return (
