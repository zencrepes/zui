...
const mapState = (state: iRootState) => ({
  ...
  tablePaginationRowsPerPage: state.githubMavenPoms.tablePaginationRowsPerPage,
  tablePaginationCurrentPage: state.githubMavenPoms.tablePaginationCurrentPage,
  tablePaginationOffset: state.githubMavenPoms.tablePaginationOffset,
  tablePaginationLimit: state.githubMavenPoms.tablePaginationLimit,
});

const mapDispatch = (dispatch: any) => ({
  setTablePaginationRowsPerPage: dispatch.githubMavenPoms.setTablePaginationRowsPerPage,
  setTablePaginationCurrentPage: dispatch.githubMavenPoms.setTablePaginationCurrentPage,
  setTablePaginationOffset: dispatch.githubMavenPoms.setTablePaginationOffset,
  setTablePaginationLimit: dispatch.githubMavenPoms.setTablePaginationLimit,
});
