...
const mapDispatch = (dispatch: any) => ({
  updateQueryIfDifferent: dispatch.githubMavenPoms.updateQueryIfDifferent,
});
...
export default withRouter(connect(mapState, mapDispatch)(GithubMavenPoms));
